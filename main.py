...
def create_region_lists(input_image, key_image, number_of_regions):
    ...
    # encrypting regions to hide which is shuffled
    # new_region_lists = []
    # for i in region_lists[0]:
    #     add = alg.driver(int(i))
    #     add = int(add % random.randint(100, 100000))
    #     print(add)
    #     new_region_lists.append([add])
